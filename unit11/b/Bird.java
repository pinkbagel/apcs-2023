...
public class Bird {
    public static void main(String[] args) {
        ...
        System.out.println(t == "turkey"); //false because t is a new object
    ...
    private static void recur(int n) {
        if (n != 0) {
            recur(n - 2);
            System.out.print(n + " "); //1 3 5 7 (prints after the recursions)
        }
    }
    ...
    private int smallest(int[] arr, int n) { //Integer.max_Value
